...
@section('content')
  <section>
    ...
    <div class="content-wrapper">
      <h3>
        @section('title')
          {{$Title = 'Tambah Kategori Presensi'}}
        @endsection
        {{$Title}}
      </h3>
      <div class="row">
            ...
            <div class="panel-body">
              {!! Form::open(['url'=>Request::url(),'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control" type="text" name="Kode" value="{{old('Kode')}}" required pattern="[a-zA-Z0-9]+.{0,}" title="Minimal 1 Karakter" autofocus>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control" type="text" name="KodeWarna" value="{{old('KodeWarna')}}" id="demo_selectors" data-format="hex" required autofocus>
                  </div>
                </div>
